<template>
  <div class="container mx-auto flex pt-20 flex-col max-w-3xl">
    <div class="mx-auto px-4 flex-col items-center my-4">
      <div v-if="work.image !== null">
        <img :src="work.image" @error="altImg" />
      </div>
      <img v-else :src="'/img/noimage.png'" />
      <div class="mr-auto">
        <p
          v-text="work.title"
    ...
    <ul class="flex flex-wrap mx-2 mb-16 text-left text-sm">
      ...
      >
        <a
          :href="
            'https://www.amazon.co.jp/s?k=' + work.title + '&i=instant-video'
          "
          target="_blank"
      ...
      >
        <a
          :href="'https://www.netflix.com/search?q=' + work.title"
          target="_blank"
          rel="noopener noreferrer"
          >Netflix
          <svg
      ...
      >
        <a
          :href="
            'https://animestore.docomo.ne.jp/animestore/sch_pc?searchKey=' +
            work.title +
    ...
    <div v-if="$page.props.auth.user" class="flexbg-white">
      <nav class="flex flex-row justify-center">
        ...
        <Link
          ...
          class="py-4 px-6 block hover:text-blue-500 focus:outline-none"
          preserve-scroll
        >
          レビューする
        </Link>
