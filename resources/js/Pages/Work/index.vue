    ...
    <div class="flex flex-wrap -mx-4 -mb-10 text-center">
      <div class="sm:w-1/2 mb-10 px-4">
        <div class="rounded-lg h-64 overflow-hidden">
          <div>
           <img :src=" animeWorks.image  ">
          </div>
        </div>
        <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">{{ animeWorks.title }}</h2>
        <p class="leading-relaxed text-xs" >{{ animeWorks.copyright }}</p>
